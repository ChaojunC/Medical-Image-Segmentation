...
class AttU_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1, activation='sigmoid'):
    ...
    def forward(self,x):
        ...
        if self.activation == 'sigmoid':
            ...
            raise NotImplementedError('Activation should be sigmoid or softmax')
...
class NestedUNet(nn.Module):
    ...
    """
    def __init__(self, in_ch=1, out_ch=1, activation='sigmoid'):
...
class SalsaNext(nn.Module):
    def __init__(self, inch=1, nclasses=1, activation='sigmoid'):
        super(SalsaNext, self).__init__()
        self.nclasses = nclasses

        self.downCntx = ResContextBlock(inch, 32)
